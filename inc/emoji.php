...
function emoji_convert($text,$map){return str_replace(array_keys($GLOBALS['emoji_maps'][$map]),$GLOBALS['emoji_maps'][$map],$text);}
function emoji_get_name($uni_cp){return $GLOBALS['emoji_maps']['names'][$uni_cp]?$GLOBALS['emoji_maps']['names'][$uni_cp]:'?';}